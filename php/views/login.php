...
?>
 <body>
  <div class="login_container">
   <form id="login_form"  method="post" onsubmit='return submitForm(this);' action="profile.php" >
   ...
   <form id="forget_form" method="post" style="display:none;" onsubmit='submitForm(this);return false;' >
   ...
   <form id="register_form" style="display:none" action="profile.php" >
    <h1 class="login_heading">
     Register
     <span>
      /
