<div class="row" >
	<div class='s12 l3 col' >
		<div class='card ' >
			<?php
				load_view("input3", array("id" => "searchgroup", "label" => "Search", "divclass" => "input-field p5" ));
			?>
	...
	<div class='s12 l9 col' >
		<div class='card ' >
			<form onsubmit="if(form.valid.action(this)){form.sendreq1(this,$(this).find('button[type=submit]')[0]);$('#msgcontent').val('');};return false;" data-action='sendmsg' data-param='{"rid":$("#sendto").val()}' data-res='funcs.f1(obj);' id="sendmsgform" >
				<div class="card white " style='margin-top:0px;' >
					<div class='card-content' style='padding-bottom:0px;' >
						<div class="row" >
							<div class='s12 l3 col' >
								<select class='browser-default select2' style='width:100%;' id="sendto" data-condition='simple' >
			...
			<div style='padding:10px;' id="loadchat"  data-min="-1" data-max="0" data-minl="3" data-maxl="-1" data-action="personmsg" data-pid="4"  > 
			</div>
			<div style='margin-bottom:10px;margin-left:20px;' >
				<img src='photo/icons/loading2.gif' id="loadmoreloadingimg" style='visibility:hidden;' /><br>
				<a onclick='funcs.loadolder(this);' style="cursor:pointer;" id="loadmorebutton" >View More</a>
			</div>
